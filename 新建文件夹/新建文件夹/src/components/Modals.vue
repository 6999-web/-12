<template>
  ...
  <div v-else-if="activeModal && activeModal !== 'none'" class="modal-overlay" @click="closeModal">
    <div class="modal-window glass-panel" :class="modalSizeClass" @click.stop>
      ...
      <!-- 4. Laboratory Operation Event Stream (Logs log table) -->
...
const modalSizeClass = computed(() => {
  if (props.activeModal === 'space-details') return 'large-modal';
  if (props.activeModal === 'device-quick-status') return 'medium-modal';
  if (props.activeModal === 'device-full-details') return 'large-modal';
  if (props.activeModal === 'event-logs') return 'large-modal';
